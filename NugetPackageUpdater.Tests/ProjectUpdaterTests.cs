...
namespace NugetPackageUpdater.Tests
{
    ...
    public class ProjectUpdaterTests
    {
        ...
        public void ProjectConfigVersion()
        {
            ...
            result.Should().Be(@"<Reference Include=""""NLog, Version=9.9.9.9, Culture=neutral, PublicKeyToken=5120e14c03d0593c, processorArchitecture=MSIL"">");
        }
        ...
        public void ProjectConfigHint()
        {
            ...
            string result = projectUpdater.ProcessHint(line, "NLog" , "NLog.9.9.9");
